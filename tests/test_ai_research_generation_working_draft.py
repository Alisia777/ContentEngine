...
def test_api_boundary_and_scoped_cache_edges_are_wired() -> None:
    ...
    assert '"workspace-ai-research-training.js":\n      "20260826.rebuild-clean.39"' in BOOTSTRAP
    assert '"workspace-generation-research-recommendations.js":\n      "20260826.rebuild-clean.39"' in BOOTSTRAP
    assert "generation-ai-research-working-draft.js?v=20260826.rebuild-clean.39" in APP
    assert "generation-ai-research-working-draft.js?v=20260826.rebuild-clean.39" in GENERATION
