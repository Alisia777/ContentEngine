...
def test_portal_uses_recommendation_without_confirming_spend_for_user() -> None:
    ...
    assert 'from "./product-research-view.js?v=20260826.rebuild-clean.7"' in APP
    assert (
        'from "./content-generation-handoff.js?v=20260826.rebuild-clean.7"'
        in APP
    )
    assert 'from "./generation-autopilot.js?v=20260826.rebuild-clean.7"' in APP
