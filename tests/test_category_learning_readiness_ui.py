...
def test_runtime_wiring_is_bounded_honest_and_mobile_safe() -> None:
    ...
    assert '"./product-research-view.js?v=20260826.rebuild-clean.13"' in app
    assert 'href="./product-research.css?v=20260826.rebuild-clean.13"' in index
    assert (
        'src="./app.js?v=20260826.rebuild-clean.13"'
        in index
    )
