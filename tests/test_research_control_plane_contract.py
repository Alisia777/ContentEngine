...
PROVIDER_SQL_PATH = (
    ROOT / "supabase/migrations/202608040006_research_provider_control_plane.sql"
)
MARKET_SQL_PATH = (
    ROOT / "supabase/migrations/202608040007_research_market_intelligence_identity.sql"
)
