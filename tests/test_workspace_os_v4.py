...
def test_desktop_v4_6_is_the_only_eager_workspace_shell() -> None:
    ...
    assert '<link rel="stylesheet" href="./workspace-os-v4.css?v=20260811.os4.31" />' in INDEX
    assert '<script type="module" src="./workspace-os-v4-loader.js?v=20260811.os4.31"></script>' in INDEX
    ...
    assert active_modules == [
        './workspace-os-v4-loader.js?v=20260811.os4.31',
        './app.js?v=20260811.os4.31',
        './workspace-build-guard.js?v=20260811.os4.31',
    ]


def test_route_loader_uses_current_v4_6_guided_assets_and_the_dom_patch() -> None:
    for marker in (
        'const BUILD = "20260811.os4.31"',
    ...
    assert 'import { patchWorkspaceContent } from "./workspace-dom-patch.js?v=20260811.os4.31";' in APP_SCRIPT
