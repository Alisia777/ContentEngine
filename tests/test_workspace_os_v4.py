...
def test_desktop_v4_6_is_the_only_eager_workspace_shell() -> None:
    ...
    assert active_modules == [
        ...
        './app.js?v=20260823.copy-engines.41',
        './workspace-build-guard.js?v=20260823.copy-engines.41',
    ]
...
def test_route_loader_uses_current_v4_6_guided_assets_and_the_dom_patch() -> None:
    ...
    assert 'import { patchWorkspaceContent } from "./workspace-dom-patch.js?v=20260823.copy-engines.41";' in APP_SCRIPT
