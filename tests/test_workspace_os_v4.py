...
def test_desktop_v4_1_is_the_only_eager_workspace_shell() -> None:
    assert '<link rel="stylesheet" href="./workspace-os-v4.css?v=20260801.os4.1" />' in INDEX
    assert '<script type="module" src="./workspace-os-v4-loader.js?v=20260801.os4.1"></script>' in INDEX
    ...
    assert active_modules == [
        ...
        './workspace-os-v4-loader.js?v=20260801.os4.1',
        './workspace-build-guard.js?v=20260801.os4.1',
    ]
...
def test_desktop_v4_1_css_has_readable_stable_responsive_geometry() -> None:
    for marker in (
...
def test_desktop_v4_1_javascript_parses_when_node_is_available() -> None:
...
def test_desktop_v4_1_stylesheets_are_balanced() -> None:
    for stylesheet in (
        CORE_CSS,
        POLISH_CSS,
        STABILITY_CSS,
