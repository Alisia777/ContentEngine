...
def test_build_id_is_consistent_across_entrypoints() -> None:
    ...
    assert MANIFEST["label"] == "ContentEngine OS v3 · Full Production Suite"


def test_build_guard_assets_load_last_and_bust_the_new_os_cache() -> None:
    assert './workspace-build-guard.css?v=20260731.2' in APP_INDEX
    assert './workspace-build-guard.js?v=20260731.2' in APP_INDEX
    assert APP_INDEX.index('./workspace-academy-lab-v3.css') < APP_INDEX.index('./workspace-build-guard.css')
    assert APP_INDEX.index('./workspace-academy-lab-v3.js') < APP_INDEX.index('./workspace-build-guard.js')
    assert './workspace-os-v3-core-a.js?v=20260731.1' in APP_INDEX
    assert './workspace-os-v3-core-b.js?v=20260731.1' in APP_INDEX
    assert './workspace-publishing-v3.js?v=20260731.1' in APP_INDEX
    assert './workspace-work-stage-v3.js?v=20260731.1' in APP_INDEX
    assert './workspace-results-v3.js?v=20260731.1' in APP_INDEX
    assert './workspace-payout-ledger-v3.js?v=20260731.1' in APP_INDEX
    assert './workspace-collaboration-v3.js?v=20260731.1' in APP_INDEX
    assert './workspace-academy-lab-v3.js?v=20260731.1' in APP_INDEX
