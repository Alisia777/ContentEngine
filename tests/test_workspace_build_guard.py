...
def test_build_id_is_consistent_across_entrypoints() -> None:
    ...
    assert build_id == "20260731.os4.1"
    ...
    assert MANIFEST["label"] == "ContentEngine Desktop v4.1 · Reference Intelligence"
...
def test_build_guard_assets_load_after_the_desktop_v4_loader() -> None:
    ...
    assert './workspace-build-guard.js?v=20260731.5' in APP_INDEX
