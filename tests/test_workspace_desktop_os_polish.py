...
def test_legacy_desktop_polish_is_not_an_active_runtime_layer() -> None:
    ...
    assert "./workspace-os-v4.css?v=20260805.os4.18" in active_assets
    assert "./workspace-os-v4-loader.js?v=20260805.os4.18" in active_assets
    assert active_assets.index("./workspace-os-v4-loader.js?v=20260805.os4.18") < active_assets.index(
