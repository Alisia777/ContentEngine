...
def test_manager_workspace_wires_server_inspection_repair_and_refresh() -> None:
    for marker in (
        'from "./access-center-view.js?v=20260826.rebuild-clean.29"',
...
def test_access_center_styles_are_scoped_responsive_theme_aware_and_injected_once() -> None:
    ...
    assert 'link.href = "./access-center.css?v=20260826.rebuild-clean.29"' in VIEW
    assert './access-center.css?v=20260826.rebuild-clean.29' in (
