...
def test_release_versions_bind_the_mode_prompt_contract() -> None:
    ...
    assert "./product-research-view.js?v=20260823.copy-engines.46" in APP
    assert "./content-generation-handoff.js?v=20260823.copy-engines.46" in APP
    assert "./supabase-api.js?v=20260823.copy-engines.46" in APP
    assert "./app.js?v=20260823.copy-engines.46" in INDEX
