...
def test_training_journey_assets_are_loaded_with_versioned_urls() -> None:
    assert './training-journey.css?v=20260823.copy-engines.57' in INDEX
    assert BUILD == "20260823.copy-engines.57"
    assert './app.js?v=20260823.copy-engines.57' in INDEX
    assert 'from "./training-journey.js?v=20260823.copy-engines.57"' in APP
