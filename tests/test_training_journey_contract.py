...
def test_training_journey_assets_are_loaded_with_versioned_urls() -> None:
    assert './training-journey.css?v=20260826.rebuild-clean.54' in INDEX
    assert BUILD == "20260826.rebuild-clean.54"
    assert './app.js?v=20260826.rebuild-clean.54' in INDEX
    assert 'from "./training-journey.js?v=20260826.rebuild-clean.54"' in APP
    assert 'from "./training-interactive.js?v=20260826.rebuild-clean.54"' in APP
