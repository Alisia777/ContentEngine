...
def test_training_journey_assets_are_loaded_with_versioned_urls() -> None:
    assert './training-journey.css?v=20260825.login-rain.5' in INDEX
    assert BUILD == "20260825.login-rain.5"
    assert './app.js?v=20260825.login-rain.5' in INDEX
    assert 'from "./training-journey.js?v=20260825.login-rain.5"' in APP
    assert 'from "./training-interactive.js?v=20260825.login-rain.5"' in APP
