...
def test_academy_uses_the_single_v44_interface_graph() -> None:
    assert BUILD == "20260825.login-rain.5"
    assert f'./interface-system.css?v={BUILD}' in ACTIVE_INDEX
    assert './workspace-os-v4.css?v=20260825.login-rain.5' in ACTIVE_INDEX

    assert f'./workspace-build-guard.js?v={BUILD}' in ACTIVE_INDEX
    assert './workspace-os-v4-loader.js?v=20260825.login-rain.5' in ACTIVE_INDEX
    assert './app.js?v=20260825.login-rain.5' in ACTIVE_INDEX
