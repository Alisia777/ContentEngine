...
def test_academy_uses_the_single_v44_interface_graph() -> None:
    ...
    assert './workspace-os-v4.css?v=20260826.rebuild-clean.45' in ACTIVE_INDEX

    assert f'./workspace-build-guard.js?v={BUILD}' in ACTIVE_INDEX
    assert './workspace-os-v4-loader.js?v=20260826.rebuild-clean.45' in ACTIVE_INDEX
    assert './app.js?v=20260826.rebuild-clean.45' in ACTIVE_INDEX
