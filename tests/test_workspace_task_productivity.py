...
def test_productivity_assets_load_after_existing_workspace_memory_layers() -> None:
    ...
    assert 'from "./workspace-task-productivity-core.js?v=20260826.rebuild-clean.57"' in SCRIPT
    assert 'from "./workspace-task-productivity-panel.js?v=20260826.rebuild-clean.57"' in SCRIPT
