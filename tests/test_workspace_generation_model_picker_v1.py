...
def test_picker_reuses_one_form_and_keeps_recommendation_advisory() -> None:
    assert 'from "./generation-model-recommendation.js?v=20260826.rebuild-clean.33"' in SUBJECT
...
def test_model_visuals_are_local_presentation_only_and_cover_the_catalog() -> None:
    assert 'from "./generation-model-visuals-v1.js?v=20260826.rebuild-clean.33"' in SUBJECT
