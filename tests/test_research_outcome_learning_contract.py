...
MIGRATION_PATH = (
    ROOT / "supabase/migrations/202608040008_research_outcome_learning_control.sql"
)
GENERATION_CONSUMPTION_MIGRATION_PATH = (
    ROOT
    / "supabase/migrations/202608040011_research_outcome_generation_consumption.sql"
)
