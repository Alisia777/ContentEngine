...
def test_account_launch_center_is_reachable_from_the_live_portal() -> None:
    assert 'from "./account-launch-view.js?v=20260716.1"' in APP
    ...
    assert './account-launch.css?v=20260716.1' in INDEX
    assert 'const ACCOUNT_VISUAL_MODULE_URL = "./account-launch-visual-examples.js?v=20260716.1"' in APP
    ...
    assert './account-launch-visual-examples.css?v=20260716.1' in INDEX
...
def test_manager_dashboard_uses_the_scoped_rpc_and_live_handlers() -> None:
    ...
    assert 'from "./manager-dashboard-view.js?v=20260716.1"' in APP
    ...
    assert './manager-dashboard.css?v=20260716.1' in INDEX
...
def test_release_assets_share_one_cache_version() -> None:
    assert './styles.css?v=20260716.1' in INDEX
    assert './config.js?v=20260716.1' in INDEX
    assert './app.js?v=20260716.1' in INDEX
    assert './supabase-api.js?v=20260716.1' in APP
    assert './catalog.js?v=20260716.1' in APP
