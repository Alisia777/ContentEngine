...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Dry-run safe campaign batch actions.")
...
def main() -> int:
    ...
    try:
        with SessionLocal() as db:
            result = BatchExecutor(db).dry_run(args.campaign_id, action_type=args.action_type)
