...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refresh launch destination capacity for a campaign.")
...
def main() -> int:
    ...
    try:
        with SessionLocal() as db:
            result = DestinationCapacityService(db).refresh(args.campaign_id)
