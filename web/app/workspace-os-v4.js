...
import { isWorkspaceActionKey, workspaceActionKey } from "./workspace-action-key.js?v=20260826.rebuild-clean.27";
import {
  createWorkspaceWindowManagerState,
  workspaceWindowManagerReducer,
} from "./workspace-window-manager-contract.js?v=20260826.rebuild-clean.27";
import {
...
} from "./workspace-dock-contract.js?v=20260826.rebuild-clean.27";
import {
...
} from "./workspace-notification-contract.js?v=20260826.rebuild-clean.27";
import {
...
} from "./workspace-embedded-window-contract.js?v=20260826.rebuild-clean.27";

const BUILD = "20260826.rebuild-clean.27";
...
const DOCK_SPRITE = new URL("./assets/workspace_dock_icon_sprite_v4_7_1.svg?v=20260826.rebuild-clean.27", import.meta.url).href;
