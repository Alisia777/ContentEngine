...
import { isWorkspaceActionKey, workspaceActionKey } from "./workspace-action-key.js?v=20260825.login-rain.5";
import {
  createWorkspaceWindowManagerState,
  workspaceWindowManagerReducer,
} from "./workspace-window-manager-contract.js?v=20260825.login-rain.5";
import {
...
} from "./workspace-dock-contract.js?v=20260825.login-rain.5";
import {
...
} from "./workspace-notification-contract.js?v=20260825.login-rain.5";
import {
...
const DOCK_SPRITE = new URL("./assets/workspace_dock_icon_sprite_v4_7_1.svg?v=20260825.login-rain.5", import.meta.url).href;
