...
import { workspaceActionKey } from "./workspace-action-key.js?v=20260823.copy-engines.60";
import {
...
const GENERATION_HOTFIX_BUILD = "20260823.copy-engines.60";
const GENERATION_INTAKE_BUILD = "20260823.copy-engines.60";
