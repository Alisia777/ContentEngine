...
import { workspaceActionKey } from "./workspace-action-key.js?v=20260823.copy-engines.53";
import {
...
const BUILD = "20260823.copy-engines.53";
const DESKTOP_CORE_BUILD = "20260822.live-windows.5";
const EMBEDDED_WINDOW_BUILD = "20260822.live-child.2";
const GENERATION_HOTFIX_BUILD = "20260823.copy-engines.53";
const GENERATION_INTAKE_BUILD = "20260823.copy-engines.53";
