...
-- Seedance can now create up to 15 seconds. Keep continuity evidence
-- fail-closed over the full generated duration and retain the same bounded
-- normal-playback strategy with no raw frames persisted.
...
begin
  ...
  return duration_value between 0.001 and 15
