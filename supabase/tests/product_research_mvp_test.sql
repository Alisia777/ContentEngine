...
-- TEST-ONLY refreshed-course gate. Paid research uses the same current-course
-- authorization boundary as production work and real generation.
...
begin
  if p_organization_id is null
    ...
    raise exception using errcode = '22023', message = 'test_course_gate_fixture_invalid';
  end if;
  ...
  loop
    ...
    if module_row.question_count < 1
      ...
      raise exception using errcode = '55000', message = 'test_course_gate_fixture_invalid';
    end if;
    ...
    insert into content_factory.training_attempts (
      ...
      module_row.question_count, module_row.question_count, module_row.question_count,
      true, answers_value,
